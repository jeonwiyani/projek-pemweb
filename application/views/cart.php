								...
								<tr class="table_row">
									...
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="<?php echo $data['jumlah'];?>">
								...
								<div class="p-t-15">
									...
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="select">
											...
											<option value="20000">DKI Jakarta</option>
											<option value="10000">Jawa Timur</option>
										</select>
										<div class="dropDownSelect2"></div>
									</div>

									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Kota / Kecamatan">
									</div>

									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Alamat lengkap">
									</div>
									...
									<div class="flex-w">
										<input type="submit" value="Update Totals" class="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15">
									</div>
